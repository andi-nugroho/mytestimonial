            ...
            <div className="flex-1 border p-4 rounded-md">
               <div className="flex flex-col md:flex-row">
                  ...
                  <div className="text-center">
                     ...
                     <div className="mt-2">
                        <h2 className="text-xl font-semibold text-center capitalize">Andi Nugroho</h2>
                  ...
                  <div className="md:pl-6 pt-4 md:pt-2">
                     ...
                     <div className="mt-3 text-md">
                        <ul className="text-gray-700">
                           <li className="mb-1">
                              <a href="https://github.com/andi-nugroho" className="hover:text-fuchsia-600 font-medium">
                                 <FontAwesomeIcon icon={faGithub} /> Github
                              </a>
                           </li>
                           <li className="mb-1">
                              <a href="https://www.linkedin.com/in/andiinugroho/" className="hover:text-fuchsia-600 font-medium">
                           ...
                           <li className="mb-1">
                              <a href="https://medium.com/@andi.dev" className="hover:text-fuchsia-600 font-medium">
